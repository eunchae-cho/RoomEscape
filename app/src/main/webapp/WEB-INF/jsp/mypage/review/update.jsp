...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
  ...
  <head>
  <meta charset="UTF-8">
  <title>[room escape] 마이페이지 - 리뷰수정</title>
	        ...
	        <div class="my_wrap">
	         ...
	         <jsp:include page="../sidebar.jsp"></jsp:include>  
	        	...
	        	<div style="border-bottom: solid">
	        		<h5 style="margin-bottom: 10px; margin-left: 10px;">리뷰 수정</h5>
	        	</div>
	        	<div style="margin: 30px; margin-top: 50px; font-size: 14px;">
	        	 ...
	        	 <input type="hidden" name="no" value="${revNo}">
	        	 <div style="margin: 30px; font-size: 14px;">
	        	 	...
	        	 	<div style="padding-block: 20px;">
	        	 		...
	        	 		<div style="text-align: center; margin-block: 100px;">
	        	 			<button type="submit" id="updateBtn" class="btn btn-find">수정</button>
	        	 		</div>
	        	 	</div>
	        	 </div>
